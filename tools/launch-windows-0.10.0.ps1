...
$fallbackStatePath = Join-Path $dataDirectory 'windows-0100-launch-fallback.json'
...
if (-not $attachedToExistingShim) {
    if ($null -ne (Get-ShimProcess)) {
        ...
        $backupDirectory = Join-Path $backupRoot "env-0100-launch-$stamp"

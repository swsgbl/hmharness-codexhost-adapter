...
$fallbackStatePath = Join-Path $dataDirectory 'windows-0101-launch-fallback.json'
...
if (-not $attachedToExistingShim) {
    if ($null -ne (Get-ShimProcess)) {
        ...
        $backupDirectory = Join-Path $backupRoot "env-0101-launch-$stamp"
